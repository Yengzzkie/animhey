...
export default function VideoPlayer() {
  return (
    <div>
      <h1>
      Search Function is currently undergoing development. Please check back in a few days.
      </h1>
      <p>
      In the meantime, feel free to enjoy the available Anime on the homepage. ˆˆ,
      </p>
      <br />
      <span className="italic underline-offset-2 underline">- <a href="https://www.facebook.com/yengzzkie">Yengzzkie</a></span>
    </div>
  );
}
